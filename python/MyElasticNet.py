...
def Core(train_x, train_y, test_x, test_y):
    ...
    with open(output_file, 'w') as out:
        ...
        for x in [x / 10.0 for x in range(10, 51, 1)]:
            ...
            print string1
            print string2
    RegressionBase.PlotPRCurve(timeout=[x / 10.0 for x in range(10, 51, 1)], actual_y=test_y, predict_y=Y_rr_pre,
                               class0precision=precision0, class1precision=precision1, class0recall=recall0,
                               class1recall=recall1)
