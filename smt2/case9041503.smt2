...
(declare-fun var_chunkqueue_append_chunkqueue_StMem_%first12_0x4b8e6a0 () (_ BitVec 64))
...
(declare-fun var_chunkqueue_append_chunkqueue_LdMem_0x112e4ee0 () (_ BitVec 64))
(declare-fun var_chunkqueue_append_chunkqueue_%pseudo_ret_7_0x112e4d50 () (_ BitVec 64))
(assert
...
(assert
 ...
 (= ieq_0x4b864e0 ?x39)))
(assert
 (= var_chunkqueue_append_chunkqueue_StMem_%first12_0x4b8e6a0 (_ bv0 64)))
(assert
...
(assert
 (let (($x87 (= var_chunkqueue_append_chunkqueue_LdMem_0x112e4ee0 var_chunkqueue_append_chunkqueue_StMem__0x830fed0)))
 (or (not (= R0xc32a150 (_ bv1 1))) $x87)))
(assert
 (let (($x91 (= var_chunkqueue_append_chunkqueue_LdMem_0x112e4ee0 var_chunkqueue_append_chunkqueue_StMem_%first12_0x4b8e6a0)))
 (or (not (= R0x4b85c50 (_ bv1 1))) $x91)))
(assert
 (let (($x91 (= var_chunkqueue_append_chunkqueue_LdMem_0x112e4ee0 var_chunkqueue_append_chunkqueue_StMem_%first12_0x4b8e6a0)))
 (let (($x87 (= var_chunkqueue_append_chunkqueue_LdMem_0x112e4ee0 var_chunkqueue_append_chunkqueue_StMem__0x830fed0)))
 (or $x87 $x91))))
(assert
 (= var_chunkqueue_append_chunkqueue_%pseudo_ret_7_0x112e4d50 var_chunkqueue_append_chunkqueue_LdMem_0x112e4ee0))
(assert
 (= var_chunkqueue_append_chunkqueue_%pseudo_ret_7_0x112e4d50 var_chunkqueue_append_chunkqueue_LdMem_0x112e4ee0))
(assert
...
(assert
 (= R0x4b85c50 (_ bv1 1)))
(assert
 (= var_chunkqueue_append_chunkqueue_%pseudo_ret_7_0x112e4d50 (_ bv0 64)))
(check-sat)
